...
For installation and use of the algorithm and the GUI follow the instructions below.
...
For more details on how to use the GUI see [Using the GUI](https://track2p.github.io/gui_overview.html)
